...
export const EvervaultCard = ({
  ...
  return (
    <div
      className={cn(
        "p-0.5  bg-transparent aspect-square  flex items-center justify-center w-full h-full absolute top-0 left-0",
        className
      )}
    >
      <div
      ...
      >
        ...
        <div className="relative -z-10 flex items-center justify-center">
          <div className="relative h-44 w-44  rounded-md flex items-center justify-center text-white font-bold text-4xl">
          </div>
        </div>
      </div>
    </div>
...
export function CardPattern({ mouseX, mouseY, randomString }: any) {
  ...
  return (
    <div className="pointer-events-none">
      <div className="absolute left-0 inset-0 rounded-md  [mask-image:linear-gradient(white,transparent)] group-hover/card:opacity-50"></div>
      <motion.div
